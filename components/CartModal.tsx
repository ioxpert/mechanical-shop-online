                      ...
                      <div key={item.id} className="flex items-start space-x-4">
                        ...
                        <div className="flex-grow">
                          ...
                          {isCustomOrderRequest && (
                            <p className="text-gray-500 text-sm whitespace-pre-wrap mt-1">
                              {item.description}
                            </p>
                          )}
                          {hasCustomInfo && (
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full p-3 border border-dashed border-secondary text-secondary rounded-md hover:bg-secondary/10 transition-colors disabled:opacity-50">
                    {isFetchingLocation
                      ? t("fetchingLocation")
                      : t("getLocationButton")}
                  </button>
