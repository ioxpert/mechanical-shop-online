...
const AboutUsPage: React.FC<AboutUsPageProps> = ({ onImageClick }) => {
      ...
      <section id="story" className="py-20 bg-white">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            ...
            />
            <div
              className="absolute inset-0 rounded-lg bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 flex items-center justify-center cursor-pointer"
              onClick={() =>
                onImageClick("workshop_img/front side shop edit.png")
              }
              aria-label={`View image of ${t("ourWorkshopAlt")} in lightbox`}>
