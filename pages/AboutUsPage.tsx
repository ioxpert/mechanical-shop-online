    ...
    <div className="bg-light">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6">
          <h1 className="text-5xl md:text-6xl font-bold font-serif mb-4 drop-shadow-lg">{t('aboutTitle')}</h1>
      ...
      <section id="story" className="py-20 bg-white">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            <img src="https://picsum.photos/seed/about-workshop/800/600" alt={t('ourWorkshopAlt')} className="rounded-lg shadow-xl w-full" />
          </div>
          <div className="md:w-1/2">
            <h2 className="text-4xl font-bold font-serif text-primary mb-6">{t('ourStoryTitle')}</h2>
      ...
      <section id="quality" className="py-20 bg-accent">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold font-serif text-primary mb-6">{t('qualityTitle')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {TOOLS_MATERIALS.map((item, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
                <img className="w-full h-56 object-cover" src={item.imageUrl} alt={t(item.nameKey)} />
                <div className="p-6">
                  <h3 className="text-xl font-bold font-serif text-primary mb-2">{t(item.nameKey)}</h3>
      ...
      <section id="team" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold font-serif text-center text-primary mb-12">{t('teamTitle')}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-center">
            {TEAM_MEMBERS.map((member, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg text-center p-8 flex flex-col items-center">
                ...
                <p className="text-secondary font-semibold mb-2">{t(member.roleKey)}</p>
