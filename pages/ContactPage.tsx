    ...
    <div className="bg-light">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6">
          <h1 className="text-5xl md:text-6xl font-bold font-serif mb-4 drop-shadow-lg">{t('contactTitle')}</h1>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-3xl font-bold font-serif text-primary mb-6">{t('contactInfoTitle')}</h2>
              <div className="space-y-6 text-gray-700">
                <div className="flex items-start space-x-4">
                  <span className="text-secondary mt-1"><PhoneIcon /></span>
                  <div>
                    <h3 className="font-semibold text-primary">{t('contactManager')}</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary">{t('contactEmail')}</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary">{t('contactLocation')}</h3>
      ...
      <section className="py-12 bg-accent">
        <div className="container mx-auto px-6 text-center">
            <h3 className="text-2xl font-bold font-serif text-primary mb-4">{t('developerTitle')}</h3>
